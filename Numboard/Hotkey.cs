...
namespace Numboard
{
	...
	{
		public event Action<HotKey, NumboardButton> HotKeyPressed;
		...
		public HotKey(ModifierKeys modifierKeys, Keys key, Window window, NumboardButton button)
